...
$sql = "SELECT * FROM tbl_student WHERE fld_studentid = ?";
...
<body>
    ...
    <div class="profile-container">
        <div class="profile-info">
            ...
            <div class="edit-profile-container">
                <p>Student ID: <input type="text" id="editStudentId" value="<?php echo $studentId; ?>" disabled></p>
    ...
    <!-- Back button -->
    <a href="mainpagestudent.html" class="back-button">
    ...
    <script>
        ...
        function sendFormData(formData) {
            ...
            xhr.open("POST", "dbupdatestudent.php", true);
